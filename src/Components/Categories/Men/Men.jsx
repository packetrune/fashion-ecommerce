...
const MenClothing = (props) => {
  ...
  const [addedToCart, setAddedToCart] = useState(Array(MenProducts.length).fill(false));
  ...
  return (
    <>
      <div className="d-flex flex-wrap gap-3 justify-content-center container" style={{ marginTop: '7%' }}>
        {MenProducts?.map((productItem, index) => {
          return (
            <div className={style.card}>
              <div className="card h-100" key={productItem.id}>
                ...
                <div className="card-body">
                  <h6 className="card-title fw-bold">{productItem.title}</h6>
